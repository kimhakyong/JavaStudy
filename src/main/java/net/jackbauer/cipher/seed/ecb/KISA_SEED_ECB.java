...
public class KISA_SEED_ECB {
	 ...
	 * @param pbData
	 *            : 복호화될 데이터 : 16 byte여야 함
	 * @param pdwRoundKey
	 *            : SeedRoundKey()에 의해 만들어진 키
	 */
	 ...
	 *            : RoundKey를 생성할 기본 키
	 * @param pdwRoundKey
	 *            : pbUserKey로 생성되는 결과 pdwRoundKey (32*4 byte)
	 */
	public static void SeedRoundKey(int[] pdwRoundKey /* [out] round keys for encryption or decryption */,
		...
		T[0] = ABCD[ABCD_A] + ABCD[ABCD_C] - KC15;
		T[1] = ABCD[ABCD_B] - ABCD[ABCD_D] + KC15;
		K[30] = SS0[GetB0(T[0]) & 0x0ff] ^ SS1[GetB1(T[0]) & 0x0ff] ^ SS2[GetB2(T[0]) & 0x0ff]
				^ SS3[GetB3(T[0]) & 0x0ff]; // K_16,0
		K[31] = SS0[GetB0(T[1]) & 0x0ff] ^ SS1[GetB1(T[1]) & 0x0ff] ^ SS2[GetB2(T[1]) & 0x0ff]
				^ SS3[GetB3(T[1]) & 0x0ff]; // K_16,1
	}
	...
	public static void main(String[] args) {
		...
		byte pbData[] = {(byte) 0xD7, (byte) 0x6D, (byte) 0x0D, (byte) 0x18, (byte) 0x32, (byte) 0x7E, (byte) 0xC5,
		...
		for (int i = 0; i < 16; i++)
			System.out.print(Integer.toHexString(0xff & pbPlain[i]) + " ");
		System.out.print("\n\n\n");
